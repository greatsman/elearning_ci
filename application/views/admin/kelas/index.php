                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <a href="<?= base_url('kelas/add'); ?>" class="btn btn-block btn-success">Tambah Kelas</a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('kelas/manage'); ?>" class="btn btn-block btn-success">Manajemen Kelas</a>
                                                <button type="button" class="btn btn-block btn-info">Edit Kelas</button>
                                                <button type="button" class="btn btn-block btn-danger">Hapus Kelas</button>
                                            </td>
                                        </tr>
                                    </table>
                                </div>

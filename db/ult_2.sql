...
--
-- Host: localhost:3306
-- Generation Time: Feb 29, 2020 at 08:31 AM
...
INSERT INTO `tb_tamu` (`id`, `no_antrian`, `tanggal`, `nama_lengkap`, `nuptk`, `no_identitas`, `alamat_instansi`, `alamat_rumah`, `daerah`, `provinsi`, `no_handphone`, `email`, `pekerjaan`, `keperluan`, `permasalahan`, `status`, `created`, `updated`) VALUES
(1, '1', '2020-02-29 00:00:00', 'Sakarias', '8252740644299993', '9202162009620061', 'jl. hahahaha', 'jl. hahaha', 2, 'Papua Barat', '085243031355', 'agung.septyanto@kemdikbud.go.id', 2, 2, 'aaaaa', 0, '2020-02-29 00:00:00', NULL);
